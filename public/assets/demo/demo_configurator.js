...
(function () {
    ...
    localStorage.getItem('direction') == 'rtl' && document.getElementById("stylesheet").setAttribute('href', window.location.origin + '/assets/css/rtl/all.min.css');
        ...
        if (dirSwitch) {
            ...
            function resetDir() {
                if (dirSwitch.checked) {
                    document.getElementById("stylesheet").setAttribute('href', window.location.origin + '/assets/css/rtl/all.min.css');
                    document.documentElement.setAttribute("dir", "rtl");
                    localStorage.setItem("direction", "rtl");
                } else {
                    document.getElementById("stylesheet").setAttribute('href', window.location.origin + '/assets/css/ltr/all.min.css');
