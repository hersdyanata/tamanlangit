                ...
                <div class="col-xl-6">
                    ...
                    <div class="mil-banner-content-frame">
                        <div class="mil-banner-content mil-text-center">
                            <h1 class="mil-mb-40">Untuk diketahui <br>bersama</h1>
                            <div class="mil-suptitle mil-breadcrumbs">
                                <ul>
                                    <li><a href="{{ route('home') }}">Beranda</a></li>
                                    <li><a href="{{ route('syarat_ketentuan') }}">Syarat & Ketentuan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="mil-content-pad mil-p-100-60 mil-mb-100">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-12">
                    <div class="mil-suptitle mil-mb-20 mil-fade-up">Syarat & Ketentuan</div>
                    <h2 class="mil-mb-60-adapt mil-fade-up">Syarat & Ketentuan {{ ENV('APP_NAME') }}</h2>
                </div>
                <div class="col-xl-12">
                    {!! $cms->content !!}
                </div>
