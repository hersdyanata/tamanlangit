...
@section('content')
                ...
                <div class="col-xl-6">
                    <div class="mil-banner-content-frame">
                        <div class="mil-banner-content mil-text-center">
                            <h1 class="mil-mb-40">Bayar Sekarang</h1>
                        </div>
                    </div>
                </div>
            </div> --}}
    ...
    <!-- banner end -->
    <br><br><br>
    <div class="mil-contact mil-p-100-100 mil-fade-up">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-xl-6">
                    <div class="mil-iconbox mil-mb-40-adapt mil-fade-up mil-text-center" style="height: 680px;">
                        ...
                        <iframe src="{{ $data->payment_url }}" frameborder="0" style="width: 100%; height: 100%;"></iframe>
                    </div>
                </div>
            </div>
        </div>
