<div class="mil-about mil-p-100-0">
    <img src="{{ asset('assets/fe/img/shapes/4.png') }}" class="mil-shape" style="width: 180%; bottom: -100%; left: -20%; opacity: .2" alt="shape">
    <div class="container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-xl-5 mil-mb-100">
                ...
                <div class="mil-illustration-1">
                    ...
                    <img src="{{ asset('assets/fe/img/shapes/3.png') }}" alt="object" class="mil-figure mil-3 mil-fade-up">
                </div>
            ...
            <div class="col-xl-6 mil-mb-100">
                ...
                <div class="mil-illustration-2">
                    ...
                    <div class="mil-main-img mil-fade-up">
                        <img src="{{ asset('assets/fe/img/images/5.png') }}" alt="img">
                    </div>
                    <img src="{{ asset('assets/fe/img/shapes/1.png') }}" alt="object" class="mil-figure mil-1 mil-fade-up">
                    <img src="{{ asset('assets/fe/img/shapes/2.png') }}" alt="object" class="mil-figure mil-2 mil-fade-up">
                    <img src="{{ asset('assets/fe/img/shapes/3.png') }}" alt="object" class="mil-figure mil-3 mil-fade-up">
