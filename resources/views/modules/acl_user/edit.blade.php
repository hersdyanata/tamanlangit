            ...
            <form id="form_data" class="form-inline">
                ...
                <div class="mb-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            <input type="hidden" name="id" id="id" class="form-control" value="{{ $old->id }}" readonly>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="hidden" name="password" id="password" class="form-control" value="{{ $old->password }}">
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6">
                            <select class="form-select" name="role" id="role">
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{ $role->name }}" {{ ($role->name == $old->roles->pluck('name')[0] ? 'selected' : '') }}>{{ $role->name }}</option>
                                @endforeach                                
                            </select>
                        </div>
                    </div>
...
<script>
    function save(){
        $.ajax({
            type: "PUT",
            url: "{{ route('acl.user.update', $old->id) }}",
