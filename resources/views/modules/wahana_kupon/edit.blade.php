                ...
                <div class="card-body border-bottom border-light">
                    <form id="form_data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <input type="hidden" class="form-control" name="id" id="id" value="{{ $kupon->id }}" readonly>
                                <input type="text" class="form-control" name="code" id="code" placeholder="Misalnya: #LiburanIED" value="{{ $kupon->code }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control upps" name="description" id="description" value="{{ $kupon->description }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control daterange-basic" name="periode" id="periode" value="{{ $kupon->start_date.' - '.$kupon->end_date }}"> 
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control select" data-minimum-results-for-search="Infinity" name="valid_for" id="valid_for">
                                    ...
                                    <option value="online" {{ ($kupon->valid_for == 'online') ? 'selected' : '' }}>Online</option>
                                    <option value="onsite" {{ ($kupon->valid_for == 'onsite') ? 'selected' : '' }}>Onsite</option>
                                    <option value="both" {{ ($kupon->valid_for == 'both') ? 'selected' : '' }}>Online & Onsite</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-10">
                                <select class="form-control multiselect" name="wahana[]" id="wahana" multiple="multiple" data-include-select-all-option="true">
                                    @foreach ($wahanas as $wahana)
                                        <option value="{{ $wahana->id }}" {{ ($kupon_wahana->contains('wahana_id', $wahana->id) ? 'selected' : '') }}>{{ ucwords(strtolower($wahana->name)) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control select" data-minimum-results-for-search="Infinity" name="discount_type" id="discount_type">
                                    ...
                                    <option value="persentase" {{ ($kupon->discount_type == 'persentase') ? 'selected' : '' }}>Persentase</option>
                                    <option value="nominal" {{ ($kupon->discount_type == 'nominal') ? 'selected' : '' }}>Nominal</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" name="discount" id="discount" value="{{ $kupon->discount }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <input type="number" class="form-control" name="quantity" id="quantity" value="{{ $kupon->quantity }}">
                            </div>
                        </div>
...
<script>
    ...
    function save(){
        $.ajax({
            type: "PUT",
            url: "{{ route('wahana.kupon.update', $kupon->id) }}",
