            ...
            <div class="card">
                ...
                <div class="card-body border-bottom border-light">
                    <form id="form_data">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-form-label col-lg-3">Nomor Batch</label>
                            <div class="col-lg-9">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="description" id="description" autocomplete="off" value="{{ $data->description }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                <input type="text" class="form-control" name="quantity" id="quantity" autocomplete="off" value="{{ $data->quantity }}" readonly>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="badge d-block bg-danger mt-1 bg-pink bg-opacity-25 text-start text-dark">Silahkan pilih "Selesai" jika batch tiket ini tidak digunakan lagi.</div>
                            </div>
                        </div>
...
<script>
    ...
    function save(){
        $.ajax({
            type: "PUT",
            url: "{{ route('tiket.data.update', $data->id) }}",
